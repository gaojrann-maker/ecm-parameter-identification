...
class ECMIdentificationAgent:
    ...
    def run(self, input_params: Dict[str, Any]) -> Dict[str, Any]:
        ...
        try:
            # 提取输入参数
            data_path = input_params.get('data_path', 'data/raw/B0005.mat')
...
def main():
    ...
    if input_params['data_path'] == default_data and (not data_path_obj.exists()):
        print("[INFO] Default data file not found:", input_params['data_path'])
        print("       Skip running pipeline for schema generation stage.")
        print("       Please provide ECM_DATA_PATH (e.g. /share/B0005.mat) when running the App.")
        return 0
